            ...
            <div className='md:w-[900px] mx-auto text-white h-[70px] flex justify-between px-3 sm:px-0 items-center '>
                ...
                <div className="flex md:hidden">
                    <button
                        ...
                        className="flex items-center px-3 py-2 border rounded text-orange-200 border-orange-200  hover:border-white duration-300">
...

            {
                state.iconHamburger && (
                    <ul className='md:hidden w-screen  h-[100px] bg-black  text-white flex flex-col gap-12 justify-center items-center text-md '>
                        <p
                            onClick={handleClickHamburger}
                            className='cursor-pointer hover:text-red-300 duration-300 z-50 bg-black absolute right-0 top-0 px-6 py-2 border-[1px] mt-3 border-orange-200 rounded-xl'>X</p>
